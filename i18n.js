(function () {
  ...
  var dict = {
    en: {
      ...
      "nav.future": "Future", "nav.faq": "FAQ", "nav.studio": "Open studio",
      ...
      "plans.pr1": "Everything in Plus", "plans.pr2": "TikTok without your Euler key",
      "plans.pr3": "ElevenLabs with your key (BYOK)", "plans.pr4": "YouTube when it opens",
    ...
    es: {
      ...
      "nav.future": "Futuro", "nav.faq": "FAQ", "nav.studio": "Abrir estudio",
      ...
      "plans.pr1": "Todo lo Plus", "plans.pr2": "TikTok sin tu clave Euler",
      "plans.pr3": "ElevenLabs con tu clave (BYOK)", "plans.pr4": "YouTube cuando abra",
    ...
    pt: {
      ...
      "nav.future": "Futuro", "nav.faq": "FAQ", "nav.studio": "Abrir estúdio",
      ...
      "plans.pr1": "Tudo do Plus", "plans.pr2": "TikTok sem sua chave Euler",
      "plans.pr3": "ElevenLabs com sua chave (BYOK)", "plans.pr4": "YouTube quando abrir",
    ...
    ja: {
      ...
      "nav.future": "今後", "nav.faq": "FAQ", "nav.studio": "スタジオを開く",
      ...
      "plans.pr1": "Plusのすべて", "plans.pr2": "EulerキーなしのTikTok",
      "plans.pr3": "自分のElevenLabsキー（BYOK）", "plans.pr4": "YouTubeは後から",
