(function () {
  ...
  var dict = {
    ...
    es: {
      ...
      "home.h1": "El chat de Twitch se oye solo.",
      ...
      "how.s2t": "Conecta Twitch", "how.s2p": "Canal en directo. Sin contraseña.",
      ...
      "feat.2t": "Ensayo", "feat.2p": "Mensajes de prueba para oír la voz.",
      "feat.3t": "Voz del navegador", "feat.3p": "Chrome lee el chat después de Probar voz.",
      ...
      "plans.f4": "Lectura en voz alta", "plans.f5": "Modo escenario",
      ...
      "plans.pr1": "Todo lo Plus", "plans.pr2": "Cola más larga que Plus",
    ...
    pt: {
      ...
      "home.h1": "Chat da Twitch, lido em voz alta.",
      ...
      "how.s2t": "Conecte a Twitch", "how.s2p": "Um canal ao vivo. Sem senha.",
      ...
      "feat.3t": "Voz do navegador", "feat.3p": "O Chrome lê o chat depois de Test voice.",
      ...
      "plans.f4": "Leitura em voz alta", "plans.f5": "Modo palco",
      ...
      "plans.pr1": "Tudo do Plus", "plans.pr2": "Fila maior que o Plus",
    ...
    ja: {
      ...
      "how.s2t": "Twitchをつなぐ", "how.s2p": "配信中のチャンネル。パスワード不要。",
      ...
      "feat.2t": "デモ", "feat.2p": "声を試す練習メッセージ。",
      "feat.3t": "ブラウザ音声", "feat.3p": "Test voiceのあと、Chromeが読み上げます。",
