...
(function () {
  ...
  var dict = {
    en: {
      ...
      "home.lead": "Open it in the browser. Nothing to install. Free needs no account.",
      ...
      "how.s3t": "Chat is read out loud", "how.s3p": "Click Test voice once, then the chat is heard.",
      ...
      "feat.3t": "Browser voice", "feat.3p": "The browser reads the chat after Test voice.",
      ...
      "fut.2": "ElevenLabs BYOK (Pro, later)",
      "fut.3": "More voices",
