...
- [x] A4. Add Account to the site nav on every public page (Home How Features Plans Future FAQ Account). Studio header: Account link next to Home. Do not restyle the reader.
- [x] A5. STOP. Commit URLs. Wait.
